...
#Raw data directory:
Reads_dir="/gpfs/projects/bsc40/current/okhannous/MeTAline_paper/BMC_version/raw_data"
...
T2T="/gpfs/projects/bsc40/project/pipelines/WGS/reference_genomes/index/T2T/T2T"
